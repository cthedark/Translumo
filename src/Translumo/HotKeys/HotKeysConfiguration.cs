...
namespace Translumo.HotKeys
{
    public class HotKeysConfiguration : BindableBase
    {
        public static HotKeysConfiguration Default => new HotKeysConfiguration()
        {
            ...
            OnceTranslateSelectedAreaKey = new HotKeyInfo(Key.OemTilde, KeyModifier.Shift),
            ...
            OnceTranslateSelectedAreaGamepadKey = new GamepadHotKeyInfo(GamepadKeyCode.None),
        ...
        public HotKeyInfo OnceTranslateSelectedAreaKey
        {
            get => _onceTranslateSelectedAreaKey;
            set
            {
                SetProperty(ref _onceTranslateSelectedAreaKey, value);
            }
        }
        ...
        public GamepadHotKeyInfo OnceTranslateSelectedAreaGamepadKey
        {
            get => _onceTranslateGamepadKey;
            set
            {
                SetProperty(ref _onceTranslateSelectedAreaGamepadKey, value);
            }
        }
        ...
        private HotKeyInfo _onceTranslateSelectedAreaKey = new HotKeyInfo(Key.OemTilde, KeyModifier.Shift);
        ...
        private GamepadHotKeyInfo _onceTranslateSelectedAreaGamepadKey = new GamepadHotKeyInfo(GamepadKeyCode.None);
