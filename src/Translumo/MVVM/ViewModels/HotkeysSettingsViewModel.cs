    ...
    public class HotkeysSettingsViewModel : IDisposable
    {
        ...
        public HotkeysSettingsViewModel(HotKeysServiceManager hotKeysServiceManager)
        {
            ...
            Model = new List<HotKeyModel>(new[]
            {
                ...
                new HotKeyModel(_configuration.OnceTranslateSelectedAreaKey,
                    hotKeysServiceManager.GamepadHotkeysEnabled ? _configuration.OnceTranslateSelectedAreaGamepadKey : defaultGamepadHotKey,
                    nameof(_configuration.OnceTranslateSelectedAreaKey), nameof(_configuration.OnceTranslateSelectedAreaGamepadKey),
                    LocalizationManager.GetValue("Str.Hotkeys.OnceTranslateSelectedArea", false, OnLocalizedValueChanged, this)),
